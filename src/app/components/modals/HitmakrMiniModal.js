...
export default function HitmakrMiniModal({
  title,
  closeButton,
  description,
  closeFunction,
    ...
    <div className={styles.miniModal}>
      <div className={styles.miniModalContainer}>
        <div className={styles.miniModalContainerHeader}>
          <div className={styles.miniModalContainerHeaderTitle}>{title}</div>
        ...
        {isAction && (
          <div className={styles.miniModalContainerAction}>{actionButton}</div>
        )}
      </div>
    </div>
  );
