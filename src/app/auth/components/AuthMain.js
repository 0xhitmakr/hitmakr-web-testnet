              ...
              {isConnected  && !hasProfile && (
                <>
                  ...
                  {balanceData?.value === 0n &&
                    currentChainId === skaleChainId && (
                      <>
                        <HitmakrMiniModal
                          title={tandds.zeroBalanceSkaleNetworkTitle}
                            ...
                            <HitmakrButton
                              buttonFunction={() =>
                                handleThirdPartyLink(
                                  `https://www.sfuelstation.com/claim-sfuel/${address}?testnet=true`
                                )
                              }
                              isLoading={isLinkOpening}
                              isDark={false}
                              buttonName={"Get Free Gas"}
                              buttonWidth={"75%"}
                            />
                          }
                        />
